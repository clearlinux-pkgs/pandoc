...
Version  : 2.11.3
Release  : 16
URL      : https://github.com/jgm/pandoc/releases/download/2.11.3/pandoc-2.11.3-linux-amd64.tar.gz
Source0  : https://github.com/jgm/pandoc/releases/download/2.11.3/pandoc-2.11.3-linux-amd64.tar.gz
...
%prep
%setup -q -n pandoc-2.11.3
cd %{_builddir}/pandoc-2.11.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608312934
