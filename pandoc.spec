...
Version  : 2.14.0.1
Release  : 23
URL      : https://github.com/jgm/pandoc/releases/download/2.14.0.1/pandoc-2.14.0.1-linux-amd64.tar.gz
Source0  : https://github.com/jgm/pandoc/releases/download/2.14.0.1/pandoc-2.14.0.1-linux-amd64.tar.gz
...
%prep
%setup -q -n pandoc-2.14.0.1
cd %{_builddir}/pandoc-2.14.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622566575
