...
Source0  : https://github.com/jgm/pandoc/releases/download/2.11.0.1/pandoc-2.11.0.1-linux-amd64.tar.gz
...
%prep
%setup -q -n pandoc-2.11.0.1
cd %{_builddir}/pandoc-2.11.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602783980
