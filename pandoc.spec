...
Source0  : https://github.com/jgm/pandoc/releases/download/2.11.3.2/pandoc-2.11.3.2-linux-amd64.tar.gz
...
%prep
%setup -q -n pandoc-2.11.3.2
cd %{_builddir}/pandoc-2.11.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609293750
