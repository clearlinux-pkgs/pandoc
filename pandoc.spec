...
Source0  : https://github.com/jgm/pandoc/releases/download/2.19.2/pandoc-2.19.2-linux-amd64.tar.gz
Source1  : https://github.com/jgm/pandoc/archive/2.19.2/sources-2.19.2.tar.gz
...
%prep
%setup -q -n pandoc-2.19.2
cd %{_builddir}
tar xf %{_sourcedir}/sources-2.19.2.tar.gz
cd %{_builddir}/pandoc-2.19.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661279184
...
cp %{_builddir}/pandoc-%{version}/COPYRIGHT %{buildroot}/usr/share/package-licenses/pandoc/cdd21a3abb40a731f6120ed35b9207097c83950d
:
