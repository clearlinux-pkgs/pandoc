...
Source0  : https://github.com/jgm/pandoc/releases/download/2.18/pandoc-2.18-linux-amd64.tar.gz
Source1  : https://github.com/jgm/pandoc/archive/2.18/sources-2.18.tar.gz
...
%prep
%setup -q -n pandoc-2.18
cd %{_builddir}
tar xf %{_sourcedir}/sources-2.18.tar.gz
cd %{_builddir}/pandoc-2.18
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649098713
...
cp %{_builddir}/pandoc-2.18/COPYING.md %{buildroot}/usr/share/package-licenses/pandoc/049f06824254a57ed970100c46dd7d580e67d0aa
cp %{_builddir}/pandoc-2.18/COPYRIGHT %{buildroot}/usr/share/package-licenses/pandoc/cdd21a3abb40a731f6120ed35b9207097c83950d
:
