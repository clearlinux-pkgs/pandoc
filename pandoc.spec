...
Source0  : https://github.com/jgm/pandoc/releases/download/2.14.0.3/pandoc-2.14.0.3-linux-amd64.tar.gz
...
%prep
%setup -q -n pandoc-2.14.0.3
cd %{_builddir}/pandoc-2.14.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624400023
