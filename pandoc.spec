...
Source0  : https://github.com/jgm/pandoc/releases/download/2.13/pandoc-2.13-linux-amd64.tar.gz
...
%prep
%setup -q -n pandoc-2.13
cd %{_builddir}/pandoc-2.13
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616609558
