...
Version  : 2.12
Release  : 20
URL      : https://github.com/jgm/pandoc/releases/download/2.12/pandoc-2.12-linux-amd64.tar.gz
Source0  : https://github.com/jgm/pandoc/releases/download/2.12/pandoc-2.12-linux-amd64.tar.gz
...
%prep
%setup -q -n pandoc-2.12
cd %{_builddir}/pandoc-2.12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615237164
