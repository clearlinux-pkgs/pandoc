...
Source0  : https://github.com/jgm/pandoc/releases/download/2.14/pandoc-2.14-linux-amd64.tar.gz
...
%prep
%setup -q -n pandoc-2.14
cd %{_builddir}/pandoc-2.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622318409
