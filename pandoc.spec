...
Version  : 2.16.2
Release  : 29
URL      : https://github.com/jgm/pandoc/releases/download/2.16.2/pandoc-2.16.2-linux-amd64.tar.gz
Source0  : https://github.com/jgm/pandoc/releases/download/2.16.2/pandoc-2.16.2-linux-amd64.tar.gz
Source1  : https://github.com/jgm/pandoc/archive/2.16.2/sources-2.16.2.tar.gz
...
%prep
%setup -q -n pandoc-2.16.2
cd %{_builddir}
tar xf %{_sourcedir}/sources-2.16.2.tar.gz
cd %{_builddir}/pandoc-2.16.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641364708
...
cp %{_builddir}/pandoc-2.16.2/COPYING.md %{buildroot}/usr/share/package-licenses/pandoc/049f06824254a57ed970100c46dd7d580e67d0aa
cp %{_builddir}/pandoc-2.16.2/COPYRIGHT %{buildroot}/usr/share/package-licenses/pandoc/0d4a866edecf76b1bfec8cadcd81fefa85716923
:
